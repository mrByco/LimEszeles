...
[key: string]: any;
    ...
    const rb = new RequestBuilder(this.rootUrl, ActionsService.AnswerPromptPath, 'post');
    if (params) {
      rb.path('userId', params.userId, {});
...
[key: string]: any;
    ...
    return this.answerPrompt$Response(params).pipe(
      map((r: StrictHttpResponse<void>) => r.body as void)
    );
  }
